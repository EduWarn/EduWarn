    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary via-primary/95 to-primary/80 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center p-12 text-white">
          <div className="mb-8">
            <img src="/team-members/eduwarn-logo.jpeg" alt="EduWarn Nepal Logo" className="h-16 w-16 rounded-xl shadow-lg mb-6" />
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 bg-background">
        <div className="max-w-md w-full">
          <div className="flex items-center gap-3 mb-8 lg:hidden">
            <img src="/team-members/eduwarn-logo.jpeg" alt="EduWarn Nepal" className="h-10 w-10 rounded-lg" />
