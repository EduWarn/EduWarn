...
const Courses: React.FC = () => {
  ...
  const levels = Array.from(new Set((courses || []).map((c: any) => c.level).filter(Boolean)));
              ...
              {isLoading ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {filteredCourses.map((course: any) => (
                    <div key={course.id} className="course-card flex flex-col h-full relative bg-card rounded-xl overflow-hidden shadow-md border">
                      ...
                      <div className="p-5 flex flex-col flex-grow">
                        ...
                        <div className="mt-auto flex items-center justify-between">
                          ...
                          <Button variant="default" onClick={() => handleCourseAccess(course.id)}>
                            View Course
                          </Button>
                        </div>
                      </div>
